...
import { Check, Award, Users, Briefcase, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    return (
        <div style={{ paddingTop: '120px', paddingBottom: '80px' }}>
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto 80px' }}>
                <h2 className="section-title" style={{ marginBottom: '48px', textAlign: 'center' }}>Why Choose Aaryan Media</h2>
            ...
            <div className="glass" style={{
                ...
                <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    <Link to="/contact" className="btn-primary" style={{ padding: '1rem 2.5rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
